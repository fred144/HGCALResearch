#define new_100GeV_Lower_cxx
// The class definition in new_100GeV_Lower.h has been generated automatically
...
//
// root> T->Process("new_100GeV_Lower.C")
// root> T->Process("new_100GeV_Lower.C","some options")
// root> T->Process("new_100GeV_Lower.C+")
//


#include "new_100GeV_Lower.h"
#include <TH2.h>
#include <TStyle.h>
#include <TH1.h>
#include <iostream>

void new_100GeV_Lower::Begin(TTree * /*tree*/)
{
...
void new_100GeV_Lower::SlaveBegin(TTree * /*tree*/)
{
   ...
   h1 = new TH1F("h1", "Reconstructed Energy 100 GeV (eta = 2.9 - 3.0)", (140-60)/1 , 60, 140);
...
Bool_t new_100GeV_Lower::Process(Long64_t entry)
{
...
void new_100GeV_Lower::SlaveTerminate()
{
...
void new_100GeV_Lower::Terminate()
{
   // The Terminate() function is the last function to be called during
   // a query. It always runs on the client, it can be used to present
   // the results graphically or save the results to file.
  // h1 -> Draw();
  TFile file_out("updated_100GeV_Lower.root","RECREATE");
  h1->Write();
  file_out.ls();
  file_out.Close();
}
