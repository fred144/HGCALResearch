...
// Tue Jun 15 11:50:46 2021 by ROOT version 6.22/09
// from TTree hgc/hgc
// found on file: /data/users/karagozm/fire3_data/11_3_0_pre5/PartGunFixedEnergy/electrons/hgcalNtuple_100.root
//////////////////////////////////////////////////////////

#ifndef new_100GeV_Lower_h
#define new_100GeV_Lower_h
...
class new_100GeV_Lower : public TSelector {
public :
   ...
   TTreeReaderArray<float> simhit_x = {fReader, "simhit_x"};
   TTreeReaderArray<float> simhit_y = {fReader, "simhit_y"};
   TTreeReaderArray<float> simhit_z = {fReader, "simhit_z"};
   TTreeReaderArray<int> simhit_layer = {fReader, "simhit_layer"};
   TTreeReaderArray<int> simhit_wafer_u = {fReader, "simhit_wafer_u"};
   TTreeReaderArray<int> simhit_wafer_v = {fReader, "simhit_wafer_v"};
   TTreeReaderArray<int> simhit_cell_u = {fReader, "simhit_cell_u"};
   TTreeReaderArray<int> simhit_cell_v = {fReader, "simhit_cell_v"};
   TTreeReaderArray<unsigned int> simhit_detid = {fReader, "simhit_detid"};
   TTreeReaderValue<vector<bool>> simhit_isHalf = {fReader, "simhit_isHalf"};
   TTreeReaderArray<int> simhit_flags = {fReader, "simhit_flags"};
   ...
   new_100GeV_Lower(TTree * /*tree*/ =0) { }
   virtual ~new_100GeV_Lower() { }
   ...
   ClassDef(new_100GeV_Lower,0);

};

#endif

#ifdef new_100GeV_Lower_cxx
void new_100GeV_Lower::Init(TTree *tree)
{
...
Bool_t new_100GeV_Lower::Notify()
{
...
#endif // #ifdef new_100GeV_Lower_cxx
