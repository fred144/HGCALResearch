...
class new_100GeV_Upper : public TSelector {
public :
   ...
   new_100GeV_Upper(TTree * /*tree*/ =0) { }
   virtual ~new_100GeV_Upper() { }
   ...
   ClassDef(new_100GeV_Upper,0);

};

#endif

#ifdef new_100GeV_Upper_cxx
void new_100GeV_Upper::Init(TTree *tree)
{
...
Bool_t new_100GeV_Upper::Notify()
{
...
#endif // #ifdef new_100GeV_Upper_cxx
