...
// Wed Oct 28 21:25:21 2020 by ROOT version 6.14/09
// from TTree hgc/hgc
...
#ifndef My100GeV1p5to1p6_h
#define My100GeV1p5to1p6_h
...
class My100GeV1p5to1p6 : public TSelector {
public :
   ...
   My100GeV1p5to1p6(TTree * /*tree*/ =0) { }
   virtual ~My100GeV1p5to1p6() { }
   ...
   ClassDef(My100GeV1p5to1p6,0);

};

#endif

#ifdef My100GeV1p5to1p6_cxx
void My100GeV1p5to1p6::Init(TTree *tree)
{
...
Bool_t My100GeV1p5to1p6::Notify()
{
...
#endif // #ifdef My100GeV1p5to1p6_cxx
