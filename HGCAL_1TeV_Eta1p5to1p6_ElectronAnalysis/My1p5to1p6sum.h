...
// Wed Oct 28 16:34:14 2020 by ROOT version 6.14/09
// from TTree hgc/hgc
// found on file: /data/users/karagozm/fire3_data/11.1.0.pre8/PartGunFixedEnergy/electrons/1TeV/singleeE1000n500_eta1p5to1p6_ntuple_file1.root
//////////////////////////////////////////////////////////

#ifndef My1p5to1p6sum_h
#define My1p5to1p6sum_h
...
class My1p5to1p6sum : public TSelector {
public :
   ...
   My1p5to1p6sum(TTree * /*tree*/ =0) { }
   virtual ~My1p5to1p6sum() { }
   ...
   ClassDef(My1p5to1p6sum,0);

};

#endif

#ifdef My1p5to1p6sum_cxx
void My1p5to1p6sum::Init(TTree *tree)
{
