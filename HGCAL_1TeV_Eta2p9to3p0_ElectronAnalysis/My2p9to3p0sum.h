...
// Sat Oct 24 23:49:35 2020 by ROOT version 6.14/09
// from TTree hgc/hgc
// found on file: /data/users/karagozm/fire3_data/11.1.0.pre8/PartGunFixedEnergy/electrons/1TeV/singleeE1000n500_eta2p9to3p0_ntuple_file1.root
//////////////////////////////////////////////////////////

#ifndef My2p9to3p0sum_h
#define My2p9to3p0sum_h
...
class My2p9to3p0sum : public TSelector {
public :
   ...
   My2p9to3p0sum(TTree * /*tree*/ =0) { }
   virtual ~My2p9to3p0sum() { }
   ...
   ClassDef(My2p9to3p0sum,0);

};

#endif

#ifdef My2p9to3p0sum_cxx
void My2p9to3p0sum::Init(TTree *tree)
{
