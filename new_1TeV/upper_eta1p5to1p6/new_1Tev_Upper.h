...
class new_1Tev_Upper : public TSelector {
public :
...
TH2F *h2; 
   ...
   new_1Tev_Upper(TTree * /*tree*/ =0) { }
   virtual ~new_1Tev_Upper() { }
   ...
   ClassDef(new_1Tev_Upper,0);

};

#endif

#ifdef new_1Tev_Upper_cxx
void new_1Tev_Upper::Init(TTree *tree)
{
...
#endif // #ifdef new_1Tev_Upper_cxx
