...
// Tue Jun 15 13:24:16 2021 by ROOT version 6.22/09
// from TTree hgc/hgc
// found on file: /data/users/karagozm/fire3_data/11_3_0_pre5/PartGunFixedEnergy/electrons/hgcalNtuple_1000_1.root
//////////////////////////////////////////////////////////

#ifndef new_1Tev_Lower_h
#define new_1Tev_Lower_h
...
class new_1Tev_Lower : public TSelector {
public :
   ...
   new_1Tev_Lower(TTree * /*tree*/ =0) { }
   virtual ~new_1Tev_Lower() { }
   ...
   ClassDef(new_1Tev_Lower,0);

};

#endif

#ifdef new_1Tev_Lower_cxx
void new_1Tev_Lower::Init(TTree *tree)
{
...
#endif // #ifdef new_1Tev_Lower_cxx
